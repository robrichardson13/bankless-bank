...
public class ActiveBoatStorage extends BoatStorage {
  ...
  protected ActiveBoatStorage(SailingStorageType type, BanklessBankPlugin plugin) {
    super(type, plugin);
  }
  ...
  public String getLocationText() {
    ...
    var name =
        plugin.getClient()
            .getDBTableField(DBTableID.SailingDock.Row.SAILING_DOCK_PORT_SARIM + port, 1, 0)[0];
